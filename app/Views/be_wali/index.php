...
<div class="container">
    <form>
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Wali">
            <div id="nameHelp" class="form-text">Nama Wali tanpa menggunakan gelar</div>
            <!-- baiknya dWaliat gelar depan belakang lalu di join atau dipisah seperti ini?  -->
        </div>
        <div class="mb-3">
            <label for="name" class="form-label">Nama Lengkap</label>
            <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" placeholder="Dr. Nama Wali, MM">
            <div id="nameHelp" class="form-text">Nama Wali dengan menggunakan gelar</div>
        </div>
        <div class="mb-3">
